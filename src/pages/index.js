  ...
  render() {
    ...
    return (
      <div className="global-ansonkao global-ansonkao-home">
        <Helmet>
          <link
            href="https://fonts.googleapis.com/css?family=Fira+Sans:300,600"
            rel="stylesheet"
          />
        </Helmet>
        <main className="main">
          ...
          <section className="section">
            <p>
              <strong>
                Hi! My name is Anson, and I'm based out of Toronto.
              </strong>{" "}
              I'm an alumni of the Y Combinator S20 Batch. I love bringing
              people together at the intersection of creative mediums and
              technology to create magical experiences and build the future.
            </p>
            ...
            <p>
              I'm an alumni of the Y Combinator S20 Batch Today, I'm a seasoned
              internet startup and software engineering veteran. I have started
              several ventures of my own and joined many others, in one instance
              helping scale technology to 3 million users. I can run small
              teams, advise on strategy/architecture, and write ReactJS code at
              a level few others in Toronto can. Some startups hire me for these
              reasons on a contract basis, and you can too (
              <a href="#connect">connect with me</a>). I studied Mechatronics
              Engineering at the University of Waterloo, and I feel very at home
              in a machine shop, at the drawing board, at the computer, as well
              as on the phone.
            </p>
            <h1>
              <span role="img" aria-label="icon">
            ...
            <p>
              While I've always been good at technology, I find that my highest
              calling is not technology itself, but in using technology to
              capture people's imaginations. Towards that end, what could be
              better medium than film? &nbsp;
              <strong>I believe film is the ultimate art form.</strong>
            </p>
            <p>
              Over the past 18 months, I have indulged in a selection of
              creative film projects. Exploring the production of live action
              short films has been very fulfilling creatively, and very exciting
              from an entrepreneurship standpoint. I am searching for overlooked
              opportunities to build the future in this space. If the same is
              true for you, we should connect.
            </p>
            <p>
            ...
            <ul className="social-links">
              ...
              <li>
                <a
                  ...
                  href="https://twitter.com/sweaty__palms"
                >
                  <svg
                    className="social-icon"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  ...
                  href="https://www.linkedin.com/in/ansonkao/"
                >
                  <svg
                    className="social-icon"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  title="Read my blog at Medium"
                  href="https://medium.com/@anson_kao"
                >
                  <svg
                    className="social-icon"
                    width="24"
              ...
              <li>
                <a
                  ...
                  href="https://github.com/ansonkao"
                >
                  <svg
                    className="social-icon"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  ...
                  href="https://soundcloud.com/anson_kao"
                >
                  <svg
                    className="social-icon"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  title="Learn with me on StackOverflow"
                  href="https://stackoverflow.com/users/476426/anson-kao"
                >
                  <svg
                    className="social-icon"
                    xmlns="http://www.w3.org/2000/svg"
